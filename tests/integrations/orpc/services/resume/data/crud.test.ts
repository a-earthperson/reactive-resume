...
let draftService: typeof import("@/integrations/orpc/services/resume/data").draftService;
...
describe("draftService.create/getById", () => {
	/**
	 * @remarks
	 * Persists a data payload and verifies retrieval by identifier.
	 */
	it("creates and retrieves a data payload", async () => {
	...
	/**
	 * @remarks
	 * Ensures create uses the canonical empty data factory when no payload is provided.
	 */
	it("creates an empty data when data is omitted", async () => {
	 ...
	 */
	it("rejects malformed data identifiers", async () => {
...
describe("draftService.update", () => {
	/**
	 * @remarks
	 * Replaces the persisted data payload with new data.
	 */
	it("replaces data data with the provided payload", async () => {
...
describe("draftService.delete", () => {
	/**
	 * @remarks
	 * Removes a data and ensures it is no longer retrievable.
	 */
	it("deletes a data and blocks retrieval", async () => {
...
/**
 * @remarks
 * Validates create-from-operations semantics for data initialization.
 */
describe("draftService.createFromOperations", () => {
	/**
	 * @remarks
	 * Creates a data by applying operations onto the empty baseline.
	 */
	it("creates a data from operations applied to the empty baseline", async () => {
