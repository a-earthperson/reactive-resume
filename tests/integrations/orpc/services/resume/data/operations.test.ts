...
/**
 * @remarks
 * Validates that the data service applies a batched set of operations in order.
 */
describe("draftService.applyOperations", () => {
	 ...
	 */
	it("applies batched operations to a persisted data", async () => {
	 ...
	 */
	it("applies replace operations for core data sections", async () => {
	...
	/**
	 * @remarks
	 * Validates partial data creation followed by multiple operation batches,
	 ...
	 */
	it("rejects operations that yield invalid data payloads", async () => {
