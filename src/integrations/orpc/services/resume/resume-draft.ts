...
import { type DraftData, draftDataSchema, sectionTypeSchema } from "@/schema/resume/data";
import type { DraftOperation } from "@/schema/resume/data/operations";
import { type ResumeView, resumeViewFactory } from "@/schema/resume";
import { applyItemOpsOperation } from "@/integrations/orpc/services/resume/data/item-ops";
import { applySetFieldOperation } from "@/integrations/orpc/services/resume/data/set-field";
 ...
 * @param base - The existing data payload.
...
/**
 * @remarks Reads a resume view for data-specific operations.
 * @param input - The resume identifier and user identity.
 * @returns The resume view payload for data reads.
 */
 ...
 * @param input - The resume identifier and user identity.
 * @returns The resume view payload for further data mutations.
 */
...
export const resumeDraftService = {
	/**
	 * @remarks Retrieves the data slice for a resume record.
	 * @param input - The resume identifier and user identity.
	 * @returns The data payload and timestamps.
	 */
	...
	/**
	 * @remarks Applies an ordered list of data operations to a ResumeView payload.
