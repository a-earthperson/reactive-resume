import type { stylesSchema } from "./styles.schema";
import { WithSuffix } from "../utils";
import z from "zod";

export namespace Resume {
	export namespace Styles {
		export type Types = WithSuffix<typeof stylesSchema extends z.ZodObject<infer Shape, any> ? Shape : never, "">;
	}
}

export type ResumeStylesTypes = Resume.Styles.Types;
