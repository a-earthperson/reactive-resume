 ...
 */
import type { DraftData, DraftResume } from "./data";
import { draftFactory, sectionTypeSchema } from "./data";
import type { ResumeStyles } from "./styles/styles.factory.ts";
import { resumeStylesFactory } from "./styles/styles.factory.ts";
import type { Resume as ResumeStylesNamespace } from "./styles/styles.types.ts";
import type { ResumeView } from "./view.types.ts";

/**
 * @remarks Input contract for zipping data and styles into a view.
 * @example { data: draftFactory.data.empty(), styles: resumeStylesFactory.defaults() }
 */
...
export const resumeViewFactory = {
	/**
	 * @remarks Creates a full, default Resume View payload.
