...
export namespace Resume {
	export namespace Data {
		export type Types = WithSuffix<typeof dataSchema extends z.ZodObject<infer Shape, any> ? Shape : never, "">;
	}
}

export type ResumeDataTypes = Resume.Data.Types;
...
//
// /**
//  * @remarks Represents the shared identity contract for data list items.
//  * @example { id: "exp-analytical-engine-7f3k" }
//  */
// export type ListItemData = ZodInfer<typeof listItemDataSchema>;
//
// /**
//  * @remarks Namespace that groups Resume data types for cohesive use.
//  */
// export namespace Resume {
// 	/**
// 	 * @remarks Represents a single picture reference used by the data.
...
//
// 	/**
// 	 * @remarks Encapsulates the primary identity fields for the data owner.
...
//
// 	/**
// 	 * @remarks Enumerates built-in section identifiers supported by the data.
// 	 * @example "experience"
// 	 */
...
//
// 	/**
// 	 * @remarks Aggregates all built-in section data for the data.
...
//
// 	/**
// 	 * @remarks Holds metadata for data-specific behaviors or notes.
// 	 * @example { notes: "" }
// 	 */
// 	export type MetadataData = ZodInfer<typeof metadataDataSchema>;
//
// 	/**
// 	 * @remarks Top-level data data structure persisted by the /data endpoints.
...
//  * @see Resume.DraftData
//  */
// export type DraftData = Resume.DraftData;
