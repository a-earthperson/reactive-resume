 ...
 *
 * @remarks
 * Runtime validation schemas for Resume Data payloads.
 */
import z from "zod";
...
/**
 * @remarks Defines the shared identity contract for data list items.
...
/**
 * @remarks Validates the picture data for a data.
 * @example { url: "" }
 */
...
/**
 * @remarks Validates a custom field entry for a data.
...
/**
 * @remarks Validates the basics section for a data.
...
/**
 * @remarks Validates the summary section for a data.
...
/**
 * @remarks Validates the supported section identifiers for partial resume data.
 * @example "skills"
 */
...
/**
 * @remarks Validates the aggregate sections object for partial resume data.
...
/**
 * @remarks Validates a custom section item union for partial resume data.
 * @example { name: "" }
 */
...
/**
 * @remarks Validates a custom section structure for partial resume data.
...
/**
 * @remarks Validates metadata for data data.
 * @example { notes: "" }
 */
...
/**
 * @remarks Validates Resume data while allowing empty values.
